...
<meta charset="ISO-8859-1">
	...
	<script>
	alert("Already registered.Redirected to forget password page");
	function Validation()
	{
		
		var num = document.forget_form.phone.value;
	...
	<div class="login_box">
		...
		<div class="forget_page_data">
			<form action="ForgetPassword" method="post" name = "forget_form" id = "form1">
			  ...
			  <div class="container">
			    <label for="email"><b style="padding-left:60px;">Enter the registered email id </b></label>
